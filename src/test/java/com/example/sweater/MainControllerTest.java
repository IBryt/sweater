...
@Sql(value = {"/sql_scripts/create_user_before.sql", "/sql_scripts/messages_list_before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/sql_scripts/messages_list_after.sql", "/sql_scripts/create_user_after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
